...
TEMPLATES = [
    {
        ...
        'steps': [
            ...
            ('deactivate', "Désactiver l'ancien bénéficiaire", 'RDO', 'beneficiary_deactivate'),
            ('replace', 'Créer le nouveau bénéficiaire', 'RDO', 'beneficiary_replace'),
    ...
    },
    {
        ...
        'steps': [
            ...
            ('deactivate', 'Désactiver le bénéficiaire', 'RDO', 'beneficiary_deactivate'),
    ...
    },
    {
        ...
        'steps': [
            ...
            ('deactivate', 'Désactiver le doublon', 'RDO', 'beneficiary_deactivate'),
            ('notify', 'Notification finale', 'RIUIRCH', 'notify_completion'),
        ],
    },
    {
