...
urlpatterns = [
    ...
    path(
        ...
        views.trigger_background_card_generation,
        name='generate_cards_background'),
    path('location/<str:location_id>/generate-cards-background/<str:location_type>/',
         views.trigger_background_card_generation, name='generate_cards_background_with_type'),

    # DASHBOARD ENDPOINTS (Materialized Views)
    path(
        'dashboard/optimized/summary/',
        optimized_dashboard_views.optimized_dashboard_summary,
        name='optimized_dashboard_summary'),
    path('dashboard/optimized/beneficiary-breakdown/',
         optimized_dashboard_views.optimized_beneficiary_breakdown,
         name='optimized_beneficiary_breakdown'),
    path('dashboard/optimized/transfer-performance/',
         optimized_dashboard_views.optimized_transfer_performance,
         name='optimized_transfer_performance'),
    path('dashboard/optimized/quarterly-trends/',
         optimized_dashboard_views.optimized_quarterly_trends,
         name='optimized_quarterly_trends'),
    ...
    path('sync/push/', sync_views.sync_push, name='sync_push'),
